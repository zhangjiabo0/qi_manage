...
#
# Structure for table "qi_contact"
#

DROP TABLE IF EXISTS `qi_contact`;
CREATE TABLE `qi_contact` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='qi_user_info';

#
# Data for table "qi_contact"
#


#
# Structure for table "qi_customer"
#

DROP TABLE IF EXISTS `qi_customer`;
CREATE TABLE `qi_customer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "qi_customer"
#


#
# Structure for table "qi_dept"
#

DROP TABLE IF EXISTS `qi_dept`;
CREATE TABLE `qi_dept` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "qi_dept"
#

INSERT INTO `qi_dept` VALUES (1,0,'A2',18,'小微企业','小微','','',0),(2,1,'YYB',18,'运营部','运营','5','',0),(3,1,'XXB',18,'IT部','IT','4','',0),(5,1,'ZJB',18,'总经办','总经','1','',0),(6,1,'GLB',18,'管理部','管理','2','',0),(7,1,'XSB',18,'销售部','销售','3','',0),(8,1,'CWB',18,'财务部','财务','2','',0),(21,1,'XSB',18,'采购部','采购','3','',0),(23,6,'HR',16,'人事科','人事','','',0),(24,6,'ZWK',16,'总务科','总务','','',0),(25,8,'KJK',16,'会计科','会计','','',0),(26,8,'JRK',16,'金融科','金融','','',0);

#
# Structure for table "qi_dept_grade"
#

DROP TABLE IF EXISTS `qi_dept_grade`;
CREATE TABLE `qi_dept_grade` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "qi_dept_grade"
#

INSERT INTO `qi_dept_grade` VALUES (16,'DG1','科','1',0),(18,'DG2','部','2',0);

#
# Structure for table "qi_doc"
#

DROP TABLE IF EXISTS `qi_doc`;
CREATE TABLE `qi_doc` (
...
#
# Data for table "qi_doc"
#


#
# Structure for table "qi_duty"
#

DROP TABLE IF EXISTS `qi_duty`;
CREATE TABLE `qi_duty` (
...
#
# Data for table "qi_duty"
#

INSERT INTO `qi_duty` VALUES (14,'P001','普通员工','',0,''),(15,'S001','财务','',0,''),(16,'W001','人事','',0,'');

#
# Structure for table "qi_file"
#

DROP TABLE IF EXISTS `qi_file`;
CREATE TABLE `qi_file` (
...
#
# Data for table "qi_file"
#


#
# Structure for table "qi_finance"
#

DROP TABLE IF EXISTS `qi_finance`;
CREATE TABLE `qi_finance` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "qi_finance"
#


#
# Structure for table "qi_finance_account"
#

DROP TABLE IF EXISTS `qi_finance_account`;
CREATE TABLE `qi_finance_account` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "qi_finance_account"
#


#
# Structure for table "qi_flow"
#

DROP TABLE IF EXISTS `qi_flow`;
CREATE TABLE `qi_flow` (
  `id` smallint(4) unsigned NOT NULL AUTO_INCREMENT,
  `doc_no` varchar(20) NOT NULL DEFAULT '' COMMENT '文档编号',
  `name` varchar(50) NOT NULL DEFAULT '' COMMENT '名称',
  `content` text NOT NULL COMMENT '内容',
...
#
# Data for table "qi_flow"
#


#
# Structure for table "qi_flow_log"
#

DROP TABLE IF EXISTS `qi_flow_log`;
CREATE TABLE `qi_flow_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "qi_flow_log"
#


#
# Structure for table "qi_flow_type"
#

DROP TABLE IF EXISTS `qi_flow_type`;
CREATE TABLE `qi_flow_type` (
...
#
# Data for table "qi_form"
#


#
# Structure for table "qi_group"
#

DROP TABLE IF EXISTS `qi_group`;
CREATE TABLE `qi_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL DEFAULT '' COMMENT '名称',
...
#
# Data for table "qi_group"
#


#
# Structure for table "qi_group_user"
#

DROP TABLE IF EXISTS `qi_group_user`;
CREATE TABLE `qi_group_user` (
...
#
# Data for table "qi_group_user"
#


#
# Structure for table "qi_info"
#

DROP TABLE IF EXISTS `qi_info`;
CREATE TABLE `qi_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_no` varchar(20) NOT NULL DEFAULT '' COMMENT '文档编号',
  `name` varchar(50) NOT NULL DEFAULT '' COMMENT '名称',
  `content` text NOT NULL COMMENT '内容',
...
#
# Data for table "qi_info"
#


#
# Structure for table "qi_info_scope"
#

DROP TABLE IF EXISTS `qi_info_scope`;
CREATE TABLE `qi_info_scope` (
...
#
# Data for table "qi_info_scope"
#


#
# Structure for table "qi_info_sign"
#

DROP TABLE IF EXISTS `qi_info_sign`;
CREATE TABLE `qi_info_sign` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "qi_info_sign"
#


#
# Structure for table "qi_mail"
#

DROP TABLE IF EXISTS `qi_mail`;
CREATE TABLE `qi_mail` (
  `id` smallint(4) unsigned NOT NULL AUTO_INCREMENT,
  `folder` int(11) NOT NULL DEFAULT '0' COMMENT '文件夹',
...
#
# Data for table "qi_mail"
#


#
# Structure for table "qi_mail_account"
#

DROP TABLE IF EXISTS `qi_mail_account`;
CREATE TABLE `qi_mail_account` (
...
#
# Data for table "qi_mail_account"
#


#
# Structure for table "qi_mail_organize"
#

DROP TABLE IF EXISTS `qi_mail_organize`;
CREATE TABLE `qi_mail_organize` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户ID',
...
#
# Data for table "qi_mail_organize"
#


#
# Structure for table "qi_message"
#

DROP TABLE IF EXISTS `qi_message`;
CREATE TABLE `qi_message` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "qi_message"
#


#
# Structure for table "qi_node"
#

DROP TABLE IF EXISTS `qi_node`;
CREATE TABLE `qi_node` (
...
#
# Data for table "qi_position"
#

INSERT INTO `qi_position` VALUES (1,'011','主管','5',0),(2,'04','经理','4',0),(3,'03','总监','3',0),(4,'02','副总','2',0),(5,'01','总经理','1',0),(6,'06','助理','6',0);

#
# Structure for table "qi_push"
#

DROP TABLE IF EXISTS `qi_push`;
CREATE TABLE `qi_push` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户ID',
  `data` text NOT NULL,
...
#
# Data for table "qi_push"
#


#
# Structure for table "qi_role"
#
...
#
# Structure for table "qi_role_duty"
#

DROP TABLE IF EXISTS `qi_role_duty`;
CREATE TABLE `qi_role_duty` (
  `role_id` smallint(6) unsigned NOT NULL,
  `duty_id` smallint(6) unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

#
# Data for table "qi_role_duty"
#

INSERT INTO `qi_role_duty` VALUES (1,15),(7,14),(1,14),(7,15),(2,14),(2,15);

#
# Structure for table "qi_role_node"
#
...
#
# Data for table "qi_role_user"
#

INSERT INTO `qi_role_user` VALUES (4,'27'),(4,'26'),(5,'31'),(3,'22'),(1,'4'),(1,'3'),(1,'35'),(1,'36'),(1,'54'),(2,'3'),(1,'53'),(7,'36'),(1,'2'),(2,'2'),(7,'2'),(1,'63'),(1,'64'),(2,'41'),(2,'68'),(1,'44'),(2,'44'),(7,'44'),(1,'67'),(2,'67'),(7,'67'),(1,'48'),(2,'48'),(7,'48'),(1,'42'),(2,'42'),(7,'42'),(1,'43'),(2,'43'),(7,'43'),(1,'49'),(2,'49'),(7,'49'),(1,'50'),(2,'50'),(7,'50'),(1,'51'),(2,'51'),(7,'51'),(1,'52'),(2,'52'),(7,'52'),(1,'55'),(2,'55'),(7,'55'),(1,'57'),(2,'57'),(7,'57'),(1,'58'),(2,'58'),(7,'58'),(1,'59'),(2,'59'),(7,'59'),(1,'60'),(2,'60'),(7,'60'),(1,'61'),(2,'61'),(7,'61'),(1,'56'),(2,'56'),(7,'56'),(1,'62'),(2,'62'),(7,'62'),(1,'65'),(2,'65'),(7,'65'),(1,'66'),(2,'66'),(7,'66'),(2,'83'),(2,'84'),(2,'87'),(2,'88'),(2,'89'),(2,'91'),(2,'92'),(2,'93'),(2,'95'),(2,'96'),(2,'97'),(2,'98'),(1,'1'),(1,'90'),(2,'90'),(7,'90'),(8,'90'),(9,'90'),(10,'90'),(11,'90'),(1,'94'),(2,'94'),(7,'94'),(8,'94'),(9,'94'),(10,'94'),(11,'94');

#
# Structure for table "qi_schedule"
#
...
#
# Data for table "qi_schedule"
#


#
# Structure for table "qi_supplier"
#

DROP TABLE IF EXISTS `qi_supplier`;
CREATE TABLE `qi_supplier` (
...
#
# Data for table "qi_supplier"
#


#
# Structure for table "qi_system_config"
#

DROP TABLE IF EXISTS `qi_system_config`;
CREATE TABLE `qi_system_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "qi_system_config"
#

INSERT INTO `qi_system_config` VALUES (39,'system_name','','小微OA',0,NULL,0,'system'),(40,'system_license','','',0,NULL,0,'system'),(41,'upload_file_ext','','',0,NULL,0,'system'),(42,'login_verify_code','','',0,NULL,0,'system');

#
# Structure for table "qi_system_folder"
#

DROP TABLE IF EXISTS `qi_system_folder`;
CREATE TABLE `qi_system_folder` (
...
#
# Data for table "qi_system_folder"
#


#
# Structure for table "qi_system_log"
#

DROP TABLE IF EXISTS `qi_system_log`;
CREATE TABLE `qi_system_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "qi_system_log"
#

INSERT INTO `qi_system_log` VALUES (41,1,1451050584,0,NULL),(42,2,1451050584,0,NULL);

#
# Structure for table "qi_system_tag"
#

DROP TABLE IF EXISTS `qi_system_tag`;
CREATE TABLE `qi_system_tag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "qi_system_tag"
#


#
# Structure for table "qi_system_tag_data"
#

DROP TABLE IF EXISTS `qi_system_tag_data`;
CREATE TABLE `qi_system_tag_data` (
...
#
# Data for table "qi_system_tag_data"
#

INSERT INTO `qi_system_tag_data` VALUES (17,70,'FlowType'),(23,72,'FlowType'),(22,72,'FlowType'),(21,72,'FlowType'),(20,72,'FlowType'),(24,70,'FlowType'),(18,71,'FlowType'),(19,71,'FlowType'),(33,71,'FlowType'),(34,71,'FlowType'),(35,71,'FlowType'),(36,71,'FlowType'),(42,70,'FlowType'),(46,70,'FlowType'),(47,70,'FlowType'),(48,70,'FlowType'),(49,70,'FlowType'),(50,70,'FlowType');

#
# Structure for table "qi_task"
#

DROP TABLE IF EXISTS `qi_task`;
CREATE TABLE `qi_task` (
...
#
# Data for table "qi_task"
#


#
# Structure for table "qi_task_log"
#

DROP TABLE IF EXISTS `qi_task_log`;
CREATE TABLE `qi_task_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "qi_task_log"
#


#
# Structure for table "qi_todo"
#

DROP TABLE IF EXISTS `qi_todo`;
CREATE TABLE `qi_todo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
...
#
# Data for table "qi_todo"
#


#
# Structure for table "qi_udf_field"
#

DROP TABLE IF EXISTS `qi_udf_field`;
CREATE TABLE `qi_udf_field` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL DEFAULT '',
...
#
# Data for table "qi_user"
#

INSERT INTO `qi_user` VALUES (1,'admin','管理员','GLY','21232f297a57a5a743894a0e4a801fc3',1,1,'male','2013-09-18','127.0.0.1',3090,'Uploads/emp_pic/1.jpeg','smeoa@qq.com','1231254123123','5086-2222-2222','12123123',1222907803,1431500668,0,'',1,1,'c81e728d9d4c2f636f067f89cc14862c');

#
# Structure for table "qi_user_config"
#

DROP TABLE IF EXISTS `qi_user_config`;
CREATE TABLE `qi_user_config` (
...
#
# Data for table "qi_user_config"
#

INSERT INTO `qi_user_config` VALUES (1,'undefined11,12,|21,22,',10,'139','mail,flow,message','mail,flow,message');

#
# Structure for table "qi_user_folder"
#

DROP TABLE IF EXISTS `qi_user_folder`;
CREATE TABLE `qi_user_folder` (
  `id` int(3) NOT NULL AUTO_INCREMENT,
  `pid` int(11) NOT NULL,
  `controller` varchar(20) NOT NULL,
  `user_id` int(11) NOT NULL,
...
#
# Data for table "qi_user_folder"
#


#
# Structure for table "qi_user_tag"
#

DROP TABLE IF EXISTS `qi_user_tag`;
CREATE TABLE `qi_user_tag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` int(11) NOT NULL DEFAULT '0',
  `controller` varchar(20) NOT NULL,
  `user_id` int(11) NOT NULL,
...
#
# Data for table "qi_user_tag"
#


#
# Structure for table "qi_user_tag_data"
#

DROP TABLE IF EXISTS `qi_user_tag_data`;
CREATE TABLE `qi_user_tag_data` (
  `row_id` int(11) NOT NULL DEFAULT '0',
  `tag_id` int(11) NOT NULL DEFAULT '0',
  `controller` varchar(20) NOT NULL DEFAULT '',
  KEY `row_id` (`row_id`)
...
#
# Data for table "qi_user_tag_data"
#


#
# Structure for table "qi_work_log"
#

DROP TABLE IF EXISTS `qi_work_log`;
CREATE TABLE `qi_work_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
